...
1. Fork the Project
2. Create your Feature Branch (`git checkout -b feature/AmazingFeatureFalan`)
3. Commit your Changes (`git commit -m 'Add some AmazingFeatureFalan'`)
4. Push to the Branch (`git push origin feature/AmazingFeatureFalan`)
